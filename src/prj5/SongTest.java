...
public class SongTest extends TestCase {
    ...
    public void testToString() {
        assertEquals("Title: title, Artist: artist,"
            + " Genre: genre, Year: 2000", song.toString());
    }
    ...
    public void testIncrement() {
        Student student = new Student("Art", "Northeast US",
            "Computer Science");
    ...
    public void testCalculateAll() {
        ...
        Student student = new Student("reading", "NorthEast",
            "Computer Science");
        Student student2 = new Student("art", "Southeast", "Other Engineering");
        Student student3 = new Student("sports", "United States "
            + "(other than Southeast or Northwest", "Math or CMDA");
        Student student4 = new Student("music", "" + "Outside of United States",
            "Other");
